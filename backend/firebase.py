    ...
    if doc.to_dict()["number"] == "9350244300":
        ...
        for doc_C in companyDocs:
            ...
            for doc_P in partiesDocs:
                ...
                for doc_T in partyTransactionsDocs:
                    ...
                    if doc_T.to_dict()["Type"] == "Sale":
                        ...
                        purchaseAmountGlobal = (
                            purchaseAmountGlobal + doc_T.to_dict()["Total"]
                        )
                ...
                partyNamesAndTotal.append(
                    {"Name": doc_P.to_dict()["PartyName"], "Amount": total_amount}
                )
    else:
...
def addData():
    ...
    db.collection(
        "users", doc.id, "company", companyID, "parties", partyID, "PartyDetails"
