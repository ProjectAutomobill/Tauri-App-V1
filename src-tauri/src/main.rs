...
#[tauri::command]
async fn add_new_business(number : String, name : String, email : String, pnumber : String) -> String{
  let mut a = String::from(url.to_owned() + &"addNewBusiness?number=");
  let mut b = String::from("&name=");
  let mut c = String::from("&pnumber=");
  let mut d = String::from("&email=");
...
#[tauri::command]
async fn new_sale_order_data(number : String, company : String, jsonData : String, totalPrice : String, recievedPrice : String){
