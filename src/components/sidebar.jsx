...
export function SideBar(props) {
    ...
    <div className="sidebarDiv">
        ...
        <div className="sidebar-Component">
            ...
            <h3 className="sideBarText" onClick={() => print("dashboard")}>Home</h3>
        </div>
        <div className="sidebar-Component">
            <BsPeopleFill className="icons"/>   
            <h3 className="sideBarText" onClick={() => print("parties")}>Parties</h3>
            <AiOutlinePlus className="plus" />
            
        </div>
        <div className="sidebar-Component">
            <HiTemplate className="icons"/>
            <h3 className="sideBarText" onClick={() => print("items")}>Items</h3>
            <AiOutlinePlus className="plus" />

        </div>
        <div className="sidebar-Component">
            <GiPaperBagOpen className="icons"/>
            <h3 className="sideBarText" id="sale-btn" onClick={() => dropdown_option("sales")}>Sales</h3>
            <FaAngleDown className="downArrow" id="sale-arrow" />
        </div>

        <div class="dropdown-container" id="sale-dropdown">
            <a href="#" className="sideBarText"  onClick={() => print("sales")}>Sale Invoices</a>
            <a href="#" className="sideBarText"  onClick={() => print("estimateAndquotation")}>Estimate/Quotation</a>
        ...
        <div className="sidebar-Component">
            ...
            <h3 className="sideBarText" onClick={() => dropdown_option_purchase("purchases")}>Purchase</h3>
            <FaAngleDown className="downArrow" id="sale-arrow" />
        ...
        <div className="sidebar-Component">
            ...
            <h3 className="sideBarText" onClick={() => print("purchases")}>Expenses</h3>
        </div>
        <div className="sidebar-Component">
            <AiFillBank className="icons"/>
            <h3 className="sideBarText" onClick={() => print("purchases")}>Cash & Banks</h3>
        </div>
        <div className="sidebar-Component">
            <BsFillBarChartFill className="icons"/>
            <h3 className="sideBarText" onClick={() => print("purchases")}>Reports</h3>
        </div>
        <div className="sidebar-Component">
            <TbFileReport className="icons"/>
            <h3 className="sideBarText" onClick={() => print("purchases")}>Other Products</h3>
        </div>
        <div className="sidebar-Component">
            <GoSync className="icons"/>
            <h3 className="sideBarText" onClick={() => print("purchases")}>Sync</h3>
        </div>
        <div className="sidebar-Component">
            <MdSettingsBackupRestore className="icons"/>
            <h3 className="sideBarText" onClick={() => print("purchases")}>Backup & Restore</h3>
        </div>
        <div className="sidebar-Component">
            <RiListSettingsFill className="icons"/>
            <h3 className="sideBarText" onClick={() => print("purchases")}>Utilities</h3>
        </div>
        <div className="sidebar-Component">
            <IoIosSettings className="icons"/>
            <h3 className="sideBarText" onClick={() => print("purchases")}>Settings</h3>
        </div>
        <div className="sidebar-Component">
            <SlBadge className="icons"/>
            <h3 className="sideBarText" onClick={() => print("purchases")}>Trial Info</h3>
        </div>
        <div className="sidebar-Component">
            <MdOutlineOndemandVideo className="icons"/>
            <h3 className="sideBarText" onClick={() => print("purchases")}>Request A Demo</h3>
        </div>
        <div className="sidebar-Component">
            <AiFillStar className="icons"/>
            <h3 className="sideBarText" onClick={() => print("purchases")}>Share FeedBack</h3>
        </div>  
    </div>
