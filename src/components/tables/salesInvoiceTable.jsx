            ...
            <TableBody>
                {
                    dataTable.map((row) =>(
                        <TableRow>
                            ...
                            <TableCell sx={{fontSize: 12}}>{row.TRANSACTION_TYPE}</TableCell>
                            <TableCell sx={{fontSize: 12}}>{row.PAYMENT_TYPE}</TableCell>
                            <TableCell sx={{fontSize: 12}}>{row.AMOUNT}</TableCell>
                            <TableCell sx={{fontSize: 12, color: 'black', fontWeight: 100}}>{row.BALANCE_DUE}</TableCell>
                        </TableRow>
                    ))
                }
            </TableBody>
