            ...
            <TableBody>
                {
                    dataTable.map((row) =>(
                        <TableRow>
                            ...
                            <TableCell sx={{fontSize: 12}}>{row.QUANTITY}</TableCell>
                            <TableCell sx={{fontSize: 12}}>{row.PRICE}</TableCell>
                            <TableCell sx={{fontSize: 12, color: 'black', fontWeight: 100}}>{row.STATUS}</TableCell>
                        </TableRow>
                    ))
                }
            </TableBody>
