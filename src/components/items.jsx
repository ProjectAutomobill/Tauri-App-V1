    ...
    <div className='parties-items'>
        ...
        <div className='upperDiv'>
            ...
            <div className='upperDivPart1'>
                ...
                <input type="text" placeholder='•Enter Business Name' id='business-entry'></input>
                </div>
        ...
        <div className='lowerBody'>
            <div className='leftDiv'>
                <div className='leftDivbtnSearch'>
                    ...
                    <button className='partyBtn'><AiOutlinePlus className="plus" />Add Item</button>
                        ...
                        <div className='upperDivRight1-items'>
                                ...
                                <div className='upperDivRight2-items'>
                                    ...
                                    <div className='upperDivRight2-part1-items'>
                                        <div className='upperDivRight2-part1-purchasePrice-items'> Purchase Price : </div>
                                        <div className='upperDivRight2-part1-salePrice-items'> Sale Price:</div>

                                    </div>

                                    <div className='upperDivRight2-part2-items'>
                                        <div className='upperDivRight2-part1-stockQuantity-items'> Stock Quantity : </div>
                                        <div className='upperDivRight2-part1-stcokValue-items'> Stock Value :</div>
                                    </div>
                                </div>
...
\                    </div>
                    ...
                    <div className='lowerDivRight'>
                        <div className='transaction-search'>
                            <h3>Transaction</h3>
                            <input type="search" name="search" id="" className='search-input' placeholder='Search...'/>
                        </div>
