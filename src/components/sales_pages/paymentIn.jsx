    ...
    <div className='main-paymentIn'>
      ...
      <div className='upperDiv-paymentIn'>
        ...
        <div className='upperDivPart1-paymentIn'>
          ...
          <input type="text" placeholder='•Enter Business Name' id='business-entry-paymentIn'></input>
          </div>
            ...
            <div className='content-middleDiv-part2-paymentIn'> 
              ...
              <div className='choose-paymentin-paymentIn'>
                <select id="paymentin-paymentIn">
                  ...
                  <option value="deliveryChallan-paymentIn">Delivery Challan</option>
                  <option value="expense-paymentIn">Expense</option>
                  <option value="partyToPartyReceived-paymentIn">Party-To-Party[Received]</option>
                  <option value="partyToPartyPaid-paymentIn">Party-To-Party[Paid]</option>
      ...
      <div className='lowerDivSale-paymentIn'>
        {/* <h3 className='transaction-paymentIn'>TRANSACTIONS</h3> */}
            <div className='top-part-A-paymentIn'>
                {/* <h3>TRANSACTIONS</h3> */}
                <input type="search" name="" id="" className='search-input-paymentIn' placeholder='Search ...'/>
                <Link to="/purchase">
                  <button className='addBtnSale-sale2-paymentIn' onClick={<Navigate to='/purchase' />}><AiOutlinePlus className="plus-paymentIn" />Add Payment-In</button>
                </Link>
            </div>
        <PaymentInTable/>
      </div>
