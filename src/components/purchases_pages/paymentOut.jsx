    ...
    <div className='main-paymentOut'>
        ...
        <div className='upperDivPart1-paymentOut'>
          ...
          <div className='marginDiv-paymentOut'>
              ...
              <div className='saleBtnDiv-paymentOut'>
                  ...
                  <button className='addBtnSale-paymentOut'>Add Sale</button>
              </div>
              <div className='purchaseBtnDiv-paymentOut'>
                  <BsFillPlusCircleFill className="plusSale-purchase-paymentOut" />
                  <button className='addBtnPurchase-paymentOut'>Add Purchase</button>
              </div>
          ...
          <div className='middleDiv-part1-paymentOut'>
            ...
            <div className='choose-months-paymentOut'>
              <select id="months-paymentOut">
                <option value="allpaymentOut-paymentOut">All Sale Invoices</option>
            ...
            <div className='content-middleDiv-part2-paymentOut'> 
              ...
              <div className='choose-sale_return-paymentOut'>
                <select id="sale_return-paymentOut">
                  <option value="allTransactions-paymentOut">All Transactions</option>
                  ...
                  <option value="deliveryChallan-paymentOut">Delivery Challan</option>
                  <option value="expense-paymentOut">Expense</option>
                  <option value="partyToPartyReceived-paymentOut">Party-To-Party[Received]</option>
                  <option value="partyToPartyPaid-paymentOut">Party-To-Party[Paid]</option>
      ...
      <div className='lowerDivSale-paymentOut'>
            <div className='top-part-A-paymentOut'>
                <input type="search" name="" id="" className='search-input-paymentOut' placeholder='Search ...'/>
                <Link to="/purchase">
                  <button className='addBtnSale-sale2-paymentOut' onClick={<Navigate to='/purchase' />}><AiOutlinePlus className="plus-paymentOut" />Add Payment-Out</button>
                </Link>
            </div>
        <PaymentOutTable/>
      </div>
