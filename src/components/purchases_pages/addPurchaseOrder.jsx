      ...
      >
        <div className="top-bar-addSale">
          <div className="window-addSale">
            <div className="window-inner-text">Purchase Order #1</div>
        ...
        <div className="purchaseTag-addSale">
          <h4 className="headingTag-addSale">Purchase Order</h4>
        </div>
        ...
        <div id="balance-box-leftDiv-addSale">
          <div className="left-div-lowerPart-addSale-des">Add Description</div>
